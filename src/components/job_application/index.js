                ...
                >
                  <li className="nav-item" role="presentation">
                    <button
                      ...
                      aria-selected="true"
                    >
                      {t("JobApplication.personalInfo.value")}
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    <button
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-7 application-tab-form-col">
                          <div className="application-tab-form-wrapper">
                            <form className="application-form">
                              <legend>
                                {t("JobApplication.uploadFileText.text")}
                              </legend>
                              <fieldset>
                                <div className="row">
                                  <div className="col-12">
                                    <div className="form-group">
                                      <label for="addCv" className="form-label">
                                        {t("JobApplication.resumeCv.value")}
                                      </label>
                                      <div className="upload-file-control">
                                        <input
                                          ...
                                          className="form-control"
                                          placeholder={t(
                                            "JobApplication.attachCv.value"
                                          )}
                                        />
                                        <button className="btn-dark outline-transparent">
                                          {t("JobApplication.uploadFile.value")}
                                        </button>
                                      </div>
                                    </div>
                                  </div>
                                  <div className="col-12">
                                    <div className="form-group">
                                      <label
                                        ...
                                        className="form-label"
                                      >
                                        {t("JobApplication.coverLetter.value")}
                                      </label>
                                      <div className="upload-file-control">
                                        <input
                                          type="text"
                                          ...
                                          className="form-control"
                                          placeholder={t(
                                            "JobApplication.attachCoverLetter.value"
                                          )}
                                        />
                                        <button className="btn-dark outline-transparent">
                                          {t("JobApplication.uploadFile.value")}
                    ...
                    <div className="tab-pane-content-wrapper w-100 text-center">
                      <div className="in-process-control">
                        ...
                        <p className="spinner-text">
                          {t("JobApplication.weProcessing.value")}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="tab-pane-content-wrapper w-100 text-center">
                      <div className="in-process-control">
                        ...
                        <p className="spinner-text">
                          {t("JobApplication.successApplication.value")}
                        </p>
                      </div>
                    </div>
                  </div>
