        ...
        <div className="modal-content">
          <div className="modal-header modal-header-fixed">
            <h2 className="modal-title">
              {t("BecomeSalon_Modal.becomeAsalon.text")}
            </h2>
            <button
              type="button"
              className="btn-close"
              ...
              <div className="accordion accordion-flush" id="siteAccordion">
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingAccordion1">
                    ...
                    >
                      {t("BecomeSalon_Modal.whatFranchise.text")}
                  ...
                  >
                    <div className="accordion-body">
                      <p>{t("BecomeSalon_Modal.whatFranchisePara1.text")}</p>
                      <p>{t("BecomeSalon_Modal.whatFranchisePara2.text")}</p>
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingAccordion2">
                    ...
                    >
                      {t("BecomeSalon_Modal.howDoIRegister.text")}
                      <i className="icon icon-chevron-down"></i>
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div className="accordion-body">
                      <p>{t("BecomeSalon_Modal.howDoIRegisterPara.text")}</p>
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingAccordion3">
                    ...
                    >
                      {t("BecomeSalon_Modal.advantagesFor.text")}
                      <i className="icon icon-chevron-down"></i>
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div className="accordion-body">
                      <p>{t("BecomeSalon_Modal.advantagesForPara.text")}</p>
                    </div>
                  </div>
                </div>
              </div>
