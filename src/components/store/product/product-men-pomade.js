...
import product_img from "../../../../public/assets/images/single-product/men-pomade/product.png";
import gallery_1_img from "../../../../public/assets/images/single-product/men-pomade/gallery-1.png";
import gallery_2_img from "../../../../public/assets/images/single-product/men-pomade/gallery-2.png";
import gallery_3_img from "../../../../public/assets/images/single-product/men-pomade/gallery-3.png";
import htu_img from "../../../../public/assets/images/single-product/men-pomade/htu.png";
import g_1_img from "../../../../public/assets/images/single-product/men-pomade/g-1.png";
import g_2_img from "../../../../public/assets/images/single-product/men-pomade/g-2.png";
import g_3_img from "../../../../public/assets/images/single-product/men-pomade/g-3.png";
import OwlCarousel from "react-owl-carousel";
import { useTranslation } from "react-i18next";

function ProductMenPomade() {
  const [t] = useTranslation("common");
  const productMenPomadeSlider = {
    loop: true,
    dots: false,
    nav: false,
    items: 1,
                ...
                <div className="single-item-banner-detail">
                  ...
                  <div className="single-item-banner-header">
                    ...
                    <h2 className="single-item-banner-category">
                      {t("Pomade.pomade1.text")}
                    </h2>
                    <h2 className="single-item-banner-price">
                      {t("Pomade.50Price.text")}
                    </h2>
                  </div>
                    ...
                    <div className="tab-content" id="myTabContent">
                      ...
                      >
                        <ul className="list-item-check-list">
                          <li>
                            <strong>{t("Pomade.moisturizing.text")}</strong>
                            {t("Pomade.moisturizingPara.text")}
                          </li>
                          <li>
                            <strong>{t("Pomade.nourishing.text")}</strong>
                            {t("Pomade.nourishingPara.text")}
                          </li>
                          <li>
                            <strong>{t("Pomade.hydration.text")}</strong>
                            {t("Pomade.hydrationPara.text")}
                          </li>
                        </ul>
                      </div>
                      <div
                      ...
                      >
                        <ul className="list-item-definition">
                          <li>
                            <strong>{t("Pomade.shampooMen.text")}</strong>
                            {t("Pomade.shampooMenPara.text")}
                          </li>
                          <li>
                            <strong>{t("Pomade.showerGelMen.text")}</strong>
                            {t("Pomade.showerGelMenPara.text")}
                          </li>
                          <li>
                            <strong>{t("Pomade.pomade.text")}</strong>
                            {t("Pomade.pomadePara.text")}
                          </li>
                        </ul>
                      </div>
                    </div>
        ...
        <div className="page-banner-strip block-vh">
          <div className="container">
            <ul className="page-banner-strip-list">
              <li>{t("Pomade.highQuality.text")}</li>
              <li>{t("Pomade.vegan.text")}</li>
              <li>{t("Pomade.crueltyFree.text")}</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="gallery-section section-content-bordered-bg">
        ...
        <div className="container">
          <div className="section-content-bordered gallery-wrapper">
            ...
            <h3 className="section-title-start">{t("Pomade.gallery.text")}</h3>
            <h3 className="section-title-end">{t("Pomade.gallery.text")}</h3>
          </div>
        </div>
      </section>
      {/* <!--Gallery Section End--> */}
          ...
          <div className="container">
            <div className="htu-banner-wrapper">
              <div className="htu-banner-content">
                <h3 className="htu-banner-title-light">{t("Pomade.howTo.text")}</h3>
                <h2 className="htu-banner-title-strong">{t("Pomade.use.text")}</h2>
              </div>
              ...
              <div className="black-card-grid black-card-htu-grid">
                <div className="black-card-item black-card-htu-item">
                  ...
                  <div className="black-card-htu-content">
                    <p>{t("Pomade.cardPara1.text")}</p>
                  </div>
                </div>
                <div className="black-card-item black-card-htu-item">
                  <h3 className="black-card-htu-title">2</h3>
                  <div className="black-card-htu-content">
                    <p>{t("Pomade.cardPara2.text")}</p>
                  </div>
                </div>
                <div className="black-card-item black-card-htu-item">
                  <h3 className="black-card-htu-title">3</h3>
                  <div className="black-card-htu-content">
                    <p>{t("Pomade.cardPara3.text")}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="section-content-bordered review-wrapper">
            <div className="review-items-wrapper">
              <div className="review-item">
                ...
                <p className="review-text">{t("Pomade.reviewsPara1.text")}</p>
                <h3 className="review-author">{t("Pomade.author1.text")}</h3>
              </div>
              <div className="review-item">
                <ul className="review-rating">
                  <li>
                ...
                <p className="review-text">{t("Pomade.reviewsPara2.text")}</p>
                <h3 className="review-author">{t("Pomade.author2.text")}</h3>
              </div>
              <div className="review-item">
                <ul className="review-rating">
                  <li>
                ...
                <p className="review-text">{t("Pomade.reviewsPara3.text")}</p>
                <h3 className="review-author">{t("Pomade.author3.text")}</h3>
              </div>
            </div>
            ...
            <h3 className="section-title-start">{t("Pomade.reviews.text")}</h3>
            <h3 className="section-title-end">{t("Pomade.reviews.text")}</h3>
          </div>
        </div>
      </section>
      {/* <!--Reviews Section End--> */}
...
export default ProductMenPomade;
