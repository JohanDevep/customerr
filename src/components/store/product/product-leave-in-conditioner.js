...
import product_img from "../../../../public/assets/images/single-product/leave-in-conditioner/product.png";
import gallery_1_img from "../../../../public/assets/images/single-product/leave-in-conditioner/gallery-1.png";
import gallery_2_img from "../../../../public/assets/images/single-product/leave-in-conditioner/gallery-2.png";
import gallery_3_img from "../../../../public/assets/images/single-product/leave-in-conditioner/gallery-3.png";
import htu_img from "../../../../public/assets/images/single-product/leave-in-conditioner/htu.png";
import g_1_img from "../../../../public/assets/images/single-product/leave-in-conditioner/g-1.png";
import g_2_img from "../../../../public/assets/images/single-product/leave-in-conditioner/g-2.png";
import g_3_img from "../../../../public/assets/images/single-product/leave-in-conditioner/g-3.png";
import OwlCarousel from "react-owl-carousel";
import { useTranslation } from "react-i18next";

function ProductLeaveInConditioner() {
  const [t] = useTranslation("common");
  const leaveInConditionerSlider = {
    loop: true,
    dots: false,
    nav: false,
    items: 1,
                ...
                <div className="single-item-banner-detail">
                  <div className="single-item-banner-rating-wrapper">
                    ...
                    <p className="single-item-banner-rating-count">
                      {t("LeaveInConditioner.120Reviews.text")}
                    </p>
                  </div>
                  <div className="single-item-banner-header">
                    <h1 className="single-item-banner-title">
                      {t("LeaveInConditioner.leaveIn.text")}
                    </h1>
                    <h2 className="single-item-banner-category">
                      {t("LeaveInConditioner.conditioner.text")}
                    </h2>
                    <h2 className="single-item-banner-price">$83.99</h2>
                  </div>
                    ...
                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          aria-selected="true"
                        >
                          {t("LeaveInConditioner.benefits.value")}
                        </button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          aria-selected="false"
                        >
                          {t("LeaveInConditioner.ingredients.value")}
                        </button>
                      </li>
                    </ul>
                    <div className="tab-content" id="myTabContent">
                      ...
                      >
                        <ul className="list-item-check-list">
                          <li>
                            <strong></strong>
                            {t("LeaveInConditioner.benefitsPara1.text")}
                          </li>
                          <li>
                            <strong></strong>
                            {t("LeaveInConditioner.benefitsPara2.text")}
                          </li>
                          <li>
                            <strong></strong>
                            {t("LeaveInConditioner.benefitsPara3.text")}
                          </li>
                          <li>
                            <strong></strong>
                            {t("LeaveInConditioner.benefitsPara4.text")}
                          </li>
                          <li>
                            <strong></strong>
                            {t("LeaveInConditioner.benefitsPara5.text")}
                          </li>
                          <li>
                            <strong></strong>
                            {t("LeaveInConditioner.benefitsPara6.text")}
                          </li>
                        </ul>
                      </div>
                      <div
                      ...
                      >
                        <ul className="list-item-definition">
                          <li>
                            <strong></strong>
                            {t("LeaveInConditioner.ingredientsPara.text")}
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <ul className="single-item-banner-cta-list">
                      <li>
                        <button className="single-item-banner-footer-cta btn-dark">
                          {t("LeaveInConditioner.shopNow.value")}
                        </button>
                      </li>
                      <li>
                        <button className="single-item-banner-footer-cta btn-dark outline">
                          {t("LeaveInConditioner.addToCart.value")}
                        </button>
                      </li>
                    </ul>
                  </div>
        ...
        <div className="page-banner-strip block-vh">
          <div className="container">
            <ul className="page-banner-strip-list">
              <li>{t("LeaveInConditioner.highQuality.text")}</li>
              <li>{t("LeaveInConditioner.vegan.text")}</li>
              <li>{t("LeaveInConditioner.crueltyFree.text")}</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="section-content-bordered gallery-wrapper">
            ...
            <h3 className="section-title-start">
              {t("LeaveInConditioner.gallery.text")}
            </h3>
            ...
            <div className="htu-banner-wrapper">
              <div className="htu-banner-content">
                <h3 className="htu-banner-title-light">
                  {t("LeaveInConditioner.howTo.text")}
                </h3>
                <h2 className="htu-banner-title-strong">
                  {t("LeaveInConditioner.use.text")}
                </h2>
              </div>
              ...
              <div className="black-card-grid black-card-htu-grid">
                <div className="black-card-item black-card-htu-item">
                  ...
                  <div className="black-card-htu-content">
                    <p>{t("LeaveInConditioner.cardPara1.text")}</p>
                  </div>
                </div>
                <div className="black-card-item black-card-htu-item">
                  <h3 className="black-card-htu-title">2</h3>
                  <div className="black-card-htu-content">
                    <p>{t("LeaveInConditioner.cardPara2.text")}</p>
                  </div>
                </div>
                <div className="black-card-item black-card-htu-item">
                  ...
                  <div className="black-card-htu-content">
                    <p>
                      <strong>{t("LeaveInConditioner.cardPara3.text")}</strong>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="section-white-wrapper">
            <h2 className="section-white-title">
              <small>{t("LeaveInConditioner.about.text")}</small>
              <span>{t("LeaveInConditioner.leaveInConditioner.text")}</span>
            </h2>
            <div className="section-white-content hr-bottom section-white-content-lg">
              <p>{t("LeaveInConditioner.leaveInConditionerPara.text")}</p>
            </div>
            <div className="section-white-footer">
              <h3 className="section-white-footer-title">
                {t("LeaveInConditioner.inspiredByYou.text")}
              </h3>
            </div>
          </div>
        </div>
      ...
      <section className="review-section section-content-bordered-bg">
        ...
        <div className="container">
          <div className="section-content-bordered review-wrapper">
            <div className="review-items-wrapper">
              <div className="review-item">
                ...
                <p className="review-text">
                  {t("LeaveInConditioner.reviewsPara1.text")}
                </p>
                <h3 className="review-author">
                  {t("LeaveInConditioner.author1.text")}
                </h3>
              </div>
              <div className="review-item">
                <ul className="review-rating">
                ...
                <p className="review-text">
                  {t("LeaveInConditioner.reviewsPara2.text")}
                </p>
                <h3 className="review-author">
                  {t("LeaveInConditioner.author2.text")}
                </h3>
              </div>
              <div className="review-item">
                <ul className="review-rating">
                ...
                <p className="review-text">
                  {t("LeaveInConditioner.reviewsPara3.text")}
                </p>
                <h3 className="review-author">
                  {t("LeaveInConditioner.author3.text")}
                </h3>
              </div>
            </div>
            ...
            <h3 className="section-title-start">
              {t("LeaveInConditioner.reviews.text")}
            </h3>
            <h3 className="section-title-end">
              {t("LeaveInConditioner.reviews.text")}
            </h3>
...
export default ProductLeaveInConditioner;
