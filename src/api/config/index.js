module.exports = {
  API_END_POINTS: {
    REGISTER: "register",
    REGISTER_BASIC: "registerBasic",
    LOGIN: "login",
    FORGOT_PASSWORD: "forgotPassword",
    FORGOT_PASSWORD_OTP_VERIFIED: "forgotPasswordOtpVerify",
    FORGOT_PASSWORD_OTP_VERIFIED_UPDATE_PASSWORD:
      "forgotPasswordOtpVerifyUpdatePassword",
    SALON_REGISTER: "salonRegister",
    GUEST_USER_AUTH_TOKEN: "getGuestUserAuthToken",
    /** subscription */
    GET_SUBSCRIPTION: "getSubscriptionCollection",
    STRIPE_SUBSCRIPTION_PAYMENT_INTENT: "postStripePaymentIntentCharge",
    GET_SUBSCRIPTION_ITEM: "getSubscriptionItem",
    GET_USER_ITEM: "getUserItem",
    STRIPE_SUBSCRIPTION_SHEET: "postStripeSubscriptionPaymentSheet",
    /** product vs collection */
    GET_PRODUCT_ITEM: "getProductItem",
    GET_PRODUCT_COLLECTION_ITEM: "getProductCollectionCollection",
    /** CART */
    GET_SHIPPING_ADDRESSES: "getUserAddressCollection",
    GET_USER_SUBSCRIPTION: "getUserSubscriptionCollection",
    GET_PRODUCT_COLLECTION: "getProductCollection",
    GET_CART_COLLECTION: "getCartCollection",
    PATCH_CART_ITEM_ITEM: "patchCartItemItem",
    DELETE_CART_ITEM_ITEM: "deleteCartItemItem",
    POST_CART_ITEM_ITEM: "postCartItemItem",
    GET_ORDER_ITEM: "getOrderItem",
    GET_CART_ITEMS:"getCartItem",
    STRIPE_ORDER_CHECKOUT_ITEM: "postStripeOrderCheckout",

    GET_QUIZ: "getQuestionCollection",
    /** Collection product */
    PRODUCT_COLLECTION_ITEM: "postProductCollectionItem",
    /** CART */
    GET_SAVED_PAYMENT_METHOD: "getStripeCustomerPaymentMethodItem",
    GET_PRODUCT_LIST: "getProductItem",
    STRIPE_ORDER_PAYMENT_INTENT: "postStripeOrderPaymentIntent",
    STRIPE_CHARGE_ORDER_PAYMENT: "postStripeOrderChargeItem",
    STRIPE_CHARGE_SUBSCRIPTION_PAYMENT: "postStripeSubscriptionChargeItem",
    STRIPE_SUBSCRIPTION_PAYMENT_SESSION: "postStripeSubscriptionCheckoutSession",
    /** Guest user token */
    GET_GUEST_USER_TOKEN: "getGuestUserAuthToken",
    /** salon location */
    GET_SALON_LOCATION: "getSalonCollection",
  },
  ACTIONS: {
    RESET_APP: "reset_app",
  },
  ...
  TOAST_STATUS: {
    ...
    RESET_PASSWORD_REQUEST:"Reset password link has been delivered to your email",
    OTP_CODE_SEND_SUCCESS: "OTP code is send successfully to your email",
    ERROR: "error",
